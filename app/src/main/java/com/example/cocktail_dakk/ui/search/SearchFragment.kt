...
class SearchFragment : BaseFragment<FragmentSearchBinding>(FragmentSearchBinding::inflate),
    SearchView, PagingView, FilterView, FilterpagingView, DetailView {
...
//                startActivity(intent)
                detailService.detail(cocktail.id)
...
//    디테일-------------------------------------------------------------------------------------------
    ...
    private fun initClicker(){
        ...
        binding.menuDetailEvaluateOkOnTv.setOnClickListener(){
            ...
            Toast.makeText(requireContext(), "별점 ${starPoint}점을 기록했습니다.", Toast.LENGTH_SHORT).show()
        }
        // 평가하기 //
    }
    ...
    private fun initCocktail(){
        ...
        for (i in 0 until keywords.size-1){
            ...
            var layoutparam = LinearLayout.LayoutParams(DPtoPX(requireContext(),10), 0)
    ...
    private fun createTextView(inputText : String, size: Float, color: String, width: Int = -1, height: Int = -1) : TextView {
        ...
        val lp =
            ...
            else LinearLayout.LayoutParams(DPtoPX(requireContext(), width), DPtoPX(requireContext(), height))
    ...
    private fun createKeyword(inputText : String, size: Float, color: String, width: Int = -1, height: Int = -1) : TextView {
        ...
        val lp =
            if (width==-1 && height==-1) LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT)
                ...
                LinearLayout.LayoutParams(DPtoPX(requireContext(), width), ViewGroup.LayoutParams.WRAP_CONTENT)
            } else LinearLayout.LayoutParams(DPtoPX(requireContext(), width), DPtoPX(requireContext(), height))
        textView.layoutParams = lp
        return textView
    }
    ...
    private fun createViewWithWeight(colorText: String, inputWeight: Float) :View{
        ...
        val lp = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DPtoPX(requireContext(), 1)).apply {
            weight = inputWeight
        }
        vu.layoutParams = lp
        return vu
    ...
    private fun createViewWithHeight(inputHeight: Int) :View{
        val vu = View(requireContext())
        val lp = LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DPtoPX(requireContext(), inputHeight))
        vu.layoutParams = lp
        return vu
    }
    ...
    private fun createIngredientWithColor(colorText:String, inputText : String, size: Float, textColor: String, width: Int = -1, height: Int = -1): LinearLayout {
        ...
        val vu = View(requireContext())
        vu.layoutParams = LinearLayout.LayoutParams(DPtoPX(requireContext(), 18), DPtoPX(requireContext(), 18))
        vu.backgroundTintList = ColorStateList.valueOf(Color.parseColor("#"+colorText))
