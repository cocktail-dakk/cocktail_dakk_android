...
class FragmentMainrecSubbaner(var imgRes : Int,var setstr :String, val setcolor : Int)
    : BaseFragment<FragmentMainrecSubbannerBinding>(FragmentMainrecSubbannerBinding::inflate) {
